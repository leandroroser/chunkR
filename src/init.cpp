...
// [[Rcpp::export]]
RcppExport SEXP chunker__new_data_frame(SEXP path_, SEXP sep_, SEXP has_colnames_,
  ...
  Rcpp::XPtr < chunker > ptr(new chunker(path, sep, has_colnames, 
...
// [[Rcpp::export]]
RcppExport SEXP chunker__new_matrix(SEXP path_, SEXP sep_, SEXP has_colnames_,
                                   SEXP has_rownames_, SEXP chunksize_) {
...
// // [[Rcpp::export]]
// RcppExport DataFrame chunker__get_matrix2dataframe(SEXP ptr) {
//   Rcpp::XPtr < chunker > data(ptr);
