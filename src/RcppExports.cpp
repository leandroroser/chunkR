...
RcppExport SEXP _reader_reader__new(SEXP path_SEXP, SEXP sep_SEXP,
		SEXP has_colnames_SEXP, SEXP has_rownames_SEXP, SEXP chunksize_SEXP) {
	BEGIN_RCPP Rcpp::RObject
	rcpp_result_gen;
	Rcpp::RNGScope rcpp_rngScope_gen;
	...
	rcpp_result_gen = Rcpp::wrap(
			reader__new(path_, sep_, has_colnames_, has_rownames_, chunksize_));
	return rcpp_result_gen;
	END_RCPP
}
...
RcppExport SEXP _reader_RcppExport_registerCCallable() {
	R_RegisterCCallable("reader", "_reader_RcppExport_validate",
			(DL_FUNC) _reader_RcppExport_validate);
	return R_NilValue;
}

RcppExport SEXP _rcpp_module_boot_reader_module();

static const R_CallMethodDef CallEntries[] = { { "_reader_matrix2df", (DL_FUNC)
		& _reader_matrix2df, 1 }, { "_reader_reader__new", (DL_FUNC)
		& _reader_reader__new, 5 }, { "_reader_reader__set_colnames", (DL_FUNC)
		& _reader_reader__set_colnames, 1 }, { "_reader_reader__next_chunk",
		(DL_FUNC) & _reader_reader__next_chunk, 1 }, {
		"_reader_reader__get_colnames", (DL_FUNC)
				& _reader_reader__get_colnames, 1 }, {
		"_reader_reader__get_data", (DL_FUNC) & _reader_reader__get_data, 1 }, {
		"_reader_reader__get_completed", (DL_FUNC)
				& _reader_reader__get_completed, 1 }, {
		"_reader_reader__as_dataframe", (DL_FUNC)
				& _reader_reader__as_dataframe, 1 }, {
		"_rcpp_module_boot_reader_module", (DL_FUNC)
				& _rcpp_module_boot_reader_module, 0 }, {
		"_reader_RcppExport_registerCCallable", (DL_FUNC)
				& _reader_RcppExport_registerCCallable, 0 }, { NULL, NULL, 0 } };
