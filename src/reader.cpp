...
reader::reader(std::string path, char sep, bool header,
               bool has_row_names, unsigned int chunksize)
  : path(path), sep(sep), header(header), has_row_names(has_row_names),
    chunksize(chunksize), n_row(0), n_col(0), 
